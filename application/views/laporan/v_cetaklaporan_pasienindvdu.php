...
<head>
    ...
    <title>Cetak Laporan Pasien Individu</title>
...
<body style="background-image: url('<?= base_url('assets/image/img_laporan/center.png') ?>'); background-repeat: no-repeat; background-size: cover">
    ...
    <main>
        <center><span>DATA LAPORAN PASIEN INDIVIDU <BR><?= $data_laporan['id_pasien']; ?></span></center><br>
        ...
        <div class="col-md-6 col-sm-6"><BR>
            <div class="field-header">Tertanda itu,</div>
            <div class="field-ttd">Psikolog Klinis</div>
