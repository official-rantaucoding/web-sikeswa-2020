...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Konseling individu</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('user/dashboard') ?>">Home</a></li>
                        <li class="breadcrumb-item active">Konseling individu</li>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Pasien Konseling Individu</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php $no = 1;
                        foreach ($data_layanan_individu as $value) { ?>
                            <tr>
                                <td><?= $no; ?></td>
                                ...
                                <td>
                                    <a href="<?= base_url('user/rekammedis/') . encrypt_url('lyi') . '/' . encrypt_url($value['id_assesment']) ?>" class="btn btn-success btn-sm"><i class="nav-icon fa fa-file-signature"></i> Tambah Rekam Medis</a>
                                    <button class="btn btn-danger btn-sm" onclick="view_lihatLayanan_konseling('<?= base_url() ?>', '<?= $value['id_pasien'] ?>', 'Konseling Individu')"><i class="fa fa-eye"></i> Lihat</button>
                                </td>
                            </tr>
                        <?php $no++;
                        } ?>
