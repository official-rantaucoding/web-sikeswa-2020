...
<div class="content-wrapper">
    ...
    <section class="content">
        <div id="message-pendaftaran"></div>
        <!-- SELECT2 EXAMPLE -->
        <div class="card card-default ">
            ...
            <form id="form-pendaftaran_peserta" method="post" action="<?= base_url('user/tambah_pendaftaran_peserta') ?>" id="form_pendaftaran_peserta" class="form-horizontal" role="form">
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <!-- posisi kanan -->
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $kode_pendaftaran; ?>" id="no_pendaftaran" name="no_pendaftaran" class="form-control" placeholder="Masukan Nomor Pendafataran" readonly>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nomor Telpon / HP (Jika diperlukan)</label>
                                <input type="text" maxlength="12" id="nomor_hp" name="nomor_hp" class="form-control notelp" placeholder="Masukan Nomor Telpon / HP, misal: 0822..xxx" onkeyup="formatTelepon('nomor_hp', this.value)" onkeypress="return hanyaAngka(event)">
                            </div>
