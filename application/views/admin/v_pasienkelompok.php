...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Pasien Kelompok</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/dashboard') ?>">Home</a></li>
                        <li class="breadcrumb-item active">Pasien Kelompok</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php $no = 1;
                        foreach ($pasien_kelompok as $value) { ?>
                            <tr>
                                <td><?= $no; ?></td>
                                ...
                                <button type="button" onclick="view_ubah_asessment('<?= base_url() ?>', '<?= $value['id_pasien'] ?>', '<?= $value['id_assesment'] ?>')" class="btn btn-primary btn-sm mb-2"><i class="fas fa-edit"></i> Ubah</button>
                                    <a href="<?= base_url('admin/cetak_kelompok/') . encrypt_url($value['id_assesment']); ?>" target="_blank" class="btn btn-danger btn-sm"><i class="fas fa-print"></i> Cetak PDF</a>
                                </td>
                            </tr>
                        <?php $no++;
                        } ?>
