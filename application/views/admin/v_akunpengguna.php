...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-default">
            ...
            <form id="form_pengguna_superadm" class="form-pengguna" action="<?= base_url('admin/tambah_pengguna') ?>" method="post" enctype="multipart/form-data">
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <button id="btn_ubah_pengguna_batal" type="button" onclick="batalUbah('<?= base_url('admin/tambah_pengguna') ?>')" class="btn btn-outline-primary" style="display: none"><i class="fas fa-times"></i> Batal</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <tbody>
                        ...
                        foreach ($data_pengguna as $value) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" onclick="ubah_pengguna('<?= base_url('admin/ubahpengguna') ?>','<?= $value['id_pengguna'] ?>')" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Ubah</button>
                                    <button type="button" onclick="hapus_pengguna('<?= base_url('admin/hapuspengguna') ?>','<?= $value['id_pengguna'] ?>')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Hapus</button>
                                </td>
                            </tr>
                        <?php  } $no++;
                        } ?>
